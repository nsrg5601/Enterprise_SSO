  ...
  return (
    <Container component="main" maxWidth="md">
      ...
      <Paper elevation={6} sx={{ padding: 2 }}>
        <Typography component="h1" variant="h5">Employee Portal</Typography>
        
        <Typography variant="h6" sx={{ mt: 2 }}>Register Employee</Typography>
        <Box sx={{ mt: 2 }}>
          <TextField
            margin="normal"
            required
        ...
        <Typography variant="h6" sx={{ mt: 2 }}>Get Employee Details</Typography>
        <Box sx={{ mt: 2 }}>
          <TextField
            margin="normal"
            required
